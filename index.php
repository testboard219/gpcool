...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>bcrantom-invest Template | Home Page 1</title>
                        ...
                        <div class="clearfix">
                        	<div class="wt-topbar-left">
                           	    <ul class="list-unstyled e-p-bx pull-left">
                                    <li><i class="fa fa-envelope"></i><a href="mailto:admin@bcrantom.com">mail bcrantom</a></li>
                                    <li><i class="fa fa-phone"></i>(347) 850-7160</li>
                                </ul>
                            </div>
                ...
                <div class="main-bar">
                    <div class="container">
                            ...
                            <div class="logo-header mostion">
                                <a href="index.html">
                                    <img src="-logo/name.png" style="width:80px;height:50px;border-radius:20px;"  alt="" />
                                </a>
                            </div>
                        ...
                        <div id="rev_slider_1014_1_wrapper" class="rev_slider_wrapper fullscreen-container" data-alias="typewriter-effect" data-source="gallery">
                           <div id="rev_slider_1014_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.1">
                                <ul>
                                    ...
                                    <div style="font-family: 'Poppins', sans-serif; text-transform:uppercase; ">
                                    	<span class="text-white" style="padding-right:10px;">bcrantom</span><span class="site-text-primary">Invest</span>
                                    </div>
                                ...
                                <div class="row call-to-action-wrap">
                                    <div class="col-lg-9 col-md-12">
                                        <div class="call-to-action-left ">
                                            ...
                                            <p>bcrantom strives to be worthy of our client's trust by providing them with services which are economically beneficial to them and to create awareness regarding reliable and highly profitable investment platform among our clients around the globe. All you need to do is sit back and enjoy how your profit grows on a daily.</p>
                                        </div>
                                    </div>
            ...
            <div class="section-full  p-t80 p-b50 bg-gray">
            	<div class="container">
                    ...
                    <div class="section-head text-center">
                        ...
                        <p>bcrantom  developed a unique evaluation process for traders, consisting of verification and secured access to your asset </p>
                    </div>
                    <!-- TITLE END-->
                    <div class="section-content">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 m-b30">
                            	<div class="wt-box graph-part-right text-white">
                                	<strong class="text-uppercase title-first">bcrantom</strong>
                            	...
                            	<div class="section-content p-tb60 p-r30 clearfix">
                                	<div class="wt-left-part any-query">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <h4 class="site-text-primary m-b0">+1 (304) 584-7415</h4>
                                        </div>    
                                    </div>
                                </div>                               
                            </div>
                            	...
                            	<div class="section-content p-tb60 p-l30 clearfix">
                                    <div class="wt-right-part any-query-contact">
                                    	...
                                    	<div class="text-center">
                                            ...
                                            <h4 class="text-secondry m-b0">support@bcrantom</h4>
                                        </div>                               
                                    </div>                                
                                </div>
                            </div>
                        ...
                        <div class="owl-carousel home-carousel-1 m-b30">
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        ...
                                        <p>bcrantom company is a great company, i love the customer support and transparency. quick payout
                                        </p>
                                    </div>
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>of all the investment program i've done, bcrantom is far the most reliable. the platform is so simple to use
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
                            ...
                            <div class="item">
                                <div class="testimonial-5">
                                    ...
                                    <div class="testimonial-paragraph">
                                        <span class="fa fa-quote-left site-text-primary"></span>
                                        <p>i've been with two other investment programs, even though those  other are quite okay,bcrantom is very diffrent than they are. you're reliable
                                        </p>
                                    </div>
                                    <div class="testimonial-detail clearfix">
