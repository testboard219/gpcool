...
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>bcrantom Template | Contact </title>
                        ...
                        <div class="clearfix">
                            <div class="wt-topbar-left">
                                <ul class="list-unstyled e-p-bx pull-left">
                                    <li><i class="fa fa-envelope"></i><a href="mailto:admin@bcrantom.com">admin@bcrantom.com</a></li>
                                    <li><i class="fa fa-phone"></i>+1(347)850-7160</li>
                                </ul>
                            </div>
            ...
            <div class="main-bar header-middle bg-black">
                <div class="container">
                    <div class="logo-header">
                        <a href="index.html">
                            <img src="mirprime-logo/name.png" width="80" height="50" style="border-radius: 20px;" alt="" />
                        </a>
                    </div>
