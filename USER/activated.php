        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-12 col-md-6 col-lg-5">
                ...
                <div class="form-group">
                        ...
                        <label for="" class="inpu-label"><h5>once account credential are verified a notification will be sent via email, Click on the continue button to proceed </h5></label>
                        <div class="input-cnt">
                ...
                <hr>
                <p style="text-align:center;"> © copyright 2024  mirprime  All Rights Reserved.</p>
